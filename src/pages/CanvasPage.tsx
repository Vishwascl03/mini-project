...
const CanvasPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen pt-16 sm:pt-20 pb-0 px-2 sm:px-6 lg:px-8 flex flex-col">
      <div className="flex-1 flex flex-col lg:flex-row gap-4 overflow-hidden">
        <div className="lg:w-3/4 flex flex-col h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)]">
          <DrawingCanvas />
        ...
        <div className="lg:w-1/4 flex-shrink-0 h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] overflow-y-auto">
          <CommentsPanel />
        </div>
      </div>
